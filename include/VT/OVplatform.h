#ifndef __vector_platform_h_
#define __vector_platform_h_ 1
...
#define OPENVECTOR_SUPPORT_INT64   1
#define OPENVECTOR_SUPPORT_FLOAT   1
#define OPENVECTOR_SUPPORT_DOUBLE  0
